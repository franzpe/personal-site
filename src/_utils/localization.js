...
const localization = new LocalizedStrings({
  en: {
    ...
    applications.`,
    aboutp3:
      "These are certifications I obtained while working at the corporate:",
    ...
    aboutFeStack:
      "My main stack that I use for frontend development every day is:",
    aboutFeStackList: [
      "React",
      "Redux / Apollo",
      "HTML5",
  ...
  sk: {
    ...
    aboutFeStack:
      "Môj hlavný technologický stack, ktorý využívam na každodenný vývoj frontendu:",
    aboutFeStackList: [
      "React",
      "Redux / Apollo",
      "HTML5",
